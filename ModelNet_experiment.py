...
from utils.modelutils import QUANN, DeepSet, MeanSet, PointNet, SetTransformer, QUANNTransformer, MLP, HPDS
...
MIN_Ks = [256, 512, 1024]
MAX_K = 2048
OUTPUT_DIR = './results/ModelNet_experiment/'
        ...
        for min_k in MIN_Ks:
            ...
            for lr in LEARNING_RATEs:
                ...
                models['SetTransformer'] = SetTransformer(
                    ...
                    latent_dim=LATENT_DIM,
                    num_heads=1,
                    projector=MLP(input_dim=3, output_dim=LATENT_DIM, hidden_dims=[256,256]),
                )
